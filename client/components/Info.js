    ...
    <div style={{ overflowX: 'hidden' }}>
      ...
      <WindoW column backgroundColor="background-white">
        ...
        >
          ...
          <p className="body-1 color-secondary p-20px">
            Richard P. Hayes, Jr. joined the partnership in 1987 and contributed
            to the development of several centers, as well as his own projects
            under Hayes Properties.
          </p>
        </Block>
        ...
        >
          ...
          <p className="body-1 color-secondary">
            ...
            located in Long Island, New York and began a new venture to develop
            grocery anchored shopping centers in Central Connecticut. One
            project led to another and over the next 20 years they completed 7
            shopping centers under the name of Hayes-Kaufman. This venture with
            Mr. Kaufman and associates proved to be a very successful
            partnership. Today, Rich Jr., along with Steve Kaufman and Marc Kemp
            continue to acquire and develop various retail properties. They are
            involved in all aspects from initial site assessments to
